                    ...
                    <div className="flex gap-2 items-center bg-gray50 rounded-[100px] py-1 pl-[5px] pr-3">
                        <div className="rounded-full relative cursor-pointer">
                            <div className="absolute w-full h-full top-0 left-0 flex items-center justify-center">
                                <h4 className="text-sm font-semibold leading-[16px] -tracking-[0.4px] text-white uppercase">{ isLoading ? '**' : initials }</h4>
                            </div>
                            <INITIALS_CONTAINER/>
                        </div>
                        <div className="cursor-pointer"><HAMBURGER_MENU/></div>
                    </div>
                </div>
            </div>
        </nav>
